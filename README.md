...
**Integration Targets**:
- [oxidizedRAG](https://github.com/lornu-ai/oxidizedRAG) - Knowledge graph retrieval (code-aware)
- [oxidizedgraph](https://github.com/lornu-ai/oxidizedgraph) - Workflow orchestration (agent lifecycle)
- [data-fabric](https://github.com/lornu-ai/data-mesh) - Schema governance & persistence

**Supporting Infrastructure**:
- [aivcs](https://github.com/lornu-ai/aivcs.io) - Agent run tracking & version control
- [bond](https://github.com/lornu-ai/bond-end) - Agent testing framework
...
<!-- Last edited by OGRE Agent at 2026-07-19 01:10:35.898943 UTC -->

<!-- Last edited by OGRE Agent at 2026-07-19 01:10:35.900086 UTC -->
