...
**NOT a framework** — a connector between existing lornu-ai + lornu-ai projects
...
|-----------|------|-------|--------|
| **oxidizedRAG** | Knowledge graph retrieval for code context | lornu-ai | Active |
| **oxidizedgraph** | LangGraph-like workflow orchestration | lornu-ai | Active |
| **data-fabric** | Schema validation & persistent knowledge | lornu-ai | Active |
| **OGRE** | Integration wiring + safety layer | lornu-ai | Planned |
| **aivcs** | Agent version control & run tracking | lornu-ai | Active |
| **bond** | Agent testing framework | lornu-ai | Active |
...
- **oxidizedRAG**: https://github.com/lornu-ai/oxidizedRAG
- **oxidizedgraph**: https://github.com/lornu-ai/oxidizedgraph
- **data-fabric**: https://github.com/lornu-ai/data-mesh
- **aivcs**: https://github.com/lornu-ai/aivcs.io
- **lornu.ai**: https://github.com/lornu-ai/lornu.ai
- **bond**: https://github.com/lornu-ai/bond-end
...
2. **Integration**: Should OGRE live in lornu-ai or lornu-ai?
